...
//-------------------------------------------------
                ...
                if ((ParamElements.length > 1) && (ParamElements[1] != null)) {
                    ...
                    ClientIpHelper.add2XML_Request_Method_CustomTags(Message.XML_Request_Method, ParamElements[0], queryParams[ queryParamIndex ].substring(ParamElements[0].length() + 1),  Controller_log);
